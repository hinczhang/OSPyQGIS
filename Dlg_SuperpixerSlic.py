...
# Form implementation generated from reading ui file 'Dlg_SuperpixerSlic.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(537, 529)
        self.verticalLayoutWidget = QtWidgets.QWidget(Dialog)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(10, 10, 521, 501))
        ...
        self.spinBox_region_size.setMaximum(999999)
        ...
        self.label_ruler = QtWidgets.QLabel(self.verticalLayoutWidget)
        self.label_ruler.setObjectName("label_ruler")
        self.verticalLayout.addWidget(self.label_ruler)
        self.doubleSpinBox_ruler = QtWidgets.QDoubleSpinBox(self.verticalLayoutWidget)
        self.doubleSpinBox_ruler.setMinimum(1.0)
        self.doubleSpinBox_ruler.setProperty("value", 10.0)
        self.doubleSpinBox_ruler.setObjectName("doubleSpinBox_ruler")
        self.verticalLayout.addWidget(self.doubleSpinBox_ruler)
        ...
        self.spinBox_num.setMaximum(99)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_ruler.setText(_translate("Dialog", "超像素平滑度"))
